...
// run `npm install` to install dependencies in package.json CHECK
...
//Basically, I need a list of mission names with buttons that lead to the show pages, i.e. the objects listed individually
